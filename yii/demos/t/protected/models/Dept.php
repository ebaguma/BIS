...
class Dept extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('dept', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, dept, parent', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'entities' => array(self::HAS_MANY, 'Entity', 'dept'),
			'templates' => array(self::HAS_MANY, 'Template', 'dept'),
			'users' => array(self::HAS_MANY, 'Users', 'dept'),
		);
	}
