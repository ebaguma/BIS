...
class Entity extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('parent, dept, rights', 'required'),
			array('parent, dept, rights', 'numerical', 'integerOnly'=>true),
			array('name, descr', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, descr, parent, dept, rights', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'templates' => array(self::HAS_MANY, 'Template', 'entity')
		);
	}
