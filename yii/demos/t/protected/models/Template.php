...
class Template extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('owner, rights', 'required'),
			array('entity, owner, rights', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, entity, owner, rights', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'owner0' => array(self::BELONGS_TO, 'Dept', 'owner'),
			'entity0' => array(self::BELONGS_TO, 'Entity', 'entity'),
			'templates' => array(self::HAS_MANY, 'Templates', 'template'),
		);
	}
