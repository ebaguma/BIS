...
<tr><td style="vertical-align:top;">
	...
	</td><td>Budget: <b><?php  echo Yii::app()->user->budget['name']; ?></b> </td><td><form method=post style='margin:0px;'>Change Budget View:<select name='mybd'><?php echo $htt; ?>
	...
	<tr><td style="padding:0 0 0 10px;vertical-align:bottom;background-color:#fff;border-top:1px solid #ccc;border-bottom:3px solid #3D89BB;" rowspan="2">
	<div class="logo">
...
<table width=100% cellpadding="0" cellspacing="0">
	<tr><td width=10% class=bg-left>&nbsp;</td>
		<td class=bg222><?php echo $content; ?></td>
		<td width=10% class=bg-right>&nbsp;</td>
</table>
</td>
</tr>
<tr class=bg-bottom style='padding:-70px'><td style='margin:-70px'>
<hr  />
