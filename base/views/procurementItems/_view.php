...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('spending')); ?>:</b>
	<?php echo CHtml::encode($data->spending); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('actual_spent')); ?>:</b>
	<?php echo CHtml::encode($data->actual_spent); ?>
	<br />
