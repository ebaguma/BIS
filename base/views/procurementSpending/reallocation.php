...
<table><tr><th>Re-allocation from:</th><th><table style='width:600px;border:0px solid'><tr>
	...
	<th style='width:300px;border:1px solid'>New Budget</th></tr></table></th></tr>
		<tr><td>
		<?php echo $form->dropDownList($model,'accountcodefrom',Chtml::ListData(AccountCodes::model()->findAll("accountcode regexp '^4'"),'id','item'),array(
	'ajax' => array(
	'type'=>'POST',
	'url'=>CController::createUrl('ProcurementSpending/itemfrom'), 
...
<tr><th>Re-allocation To:</th><th><table style='width:600px;border:0px solid'><tr>
	...
	<th style='width:300px;border:1px solid'>New Budget</th></tr></table></th></tr>
		...
		<?php echo $form->dropDownList($model,'accountcodeto',Chtml::ListData(AccountCodes::model()->findAll("accountcode regexp '^4'"),'id','item'),array(
	'id'	=>'hdhbjdhdj',
	'ajax' => array(
	'type'=>'POST',
	'url'=>CController::createUrl('ProcurementSpending/itemto'), 
	'update'=>'#ProcurementSpending_items_to',
	))); ?>
		<?php echo $form->error($model,'accountcode'); ?></td><td id='ProcurementSpending_items_to'>
