...
class ClothingController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Clothing']))
		{
			...
			$v=array();
			//echo "<pre>";
			//print_r($_POST['Clothing'][item]);
			for($i=0;$i<count($_POST['Clothing'][item]);$i++) {
				$v[] = array(
					"employee" 	=>	$_POST['Clothing'][employee],
					"item"		=>	$_POST['Clothing'][item][$i],
					"quantity"	=>	$_POST['Clothing'][quantity][$i],
					"size"		=>	$_POST['Clothing'][size][$i],
					"budget"	=>	$_POST['Clothing'][budget]
				);

			}
			//echo "<pre>";print_r($v);exit;
			GeneralRepository::insertSeveral('clothing', $v);
