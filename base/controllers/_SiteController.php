...
class SiteController extends Controller
{
	...
	public function actionExportDetails($c) {
		...
		//o$codes=Yii::app()->db->createCommand("select * from budget where accountcode = '".$cs['0']['id']."'")->queryAll();		
		$codes=Yii::app()->db->createCommand("select * from v_budget where accountcode = '".$cs['0']['id']."' and budget='".budget()."' ")->queryAll();		
