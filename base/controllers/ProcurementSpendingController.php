			...
			if($model->save()) {
   			 ...
   			 if (isset($images) && count($images) > 0) {
   				 foreach ($images as $image => $pic) {
   					 if (!$pic->saveAs(Yii::getPathOfAlias('webroot').'/appendix/p'.Yii::app()->user->budget['id'].'/'.Yii::app()->user->id.'-'.$model->id.'-'.$pic->name)) {
...
<a id="additional-link" href="#">Add Item</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="additional-linkr" href="#" style="color:red">Remove Last Item</a><table class=items><tr><th>No.</th><th>Item</th><th>Quantity</th><th>Price</th><th>Total</th><th>Available Funds</th><th>Running Balance</th></tr><tbody id="additional-inputs"></tbody><tr><td></td><td></td><td></td><td colspan=2>Grand Total</td><td colspan=2 id=alltotal style='font-weight:bold'>0</td></table>
