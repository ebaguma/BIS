...
class Sections extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('section,shortname', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, section, shortname,department', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'employees' => array(self::HAS_MANY, 'Employees', 'section'),
			'department0' => array(self::BELONGS_TO, 'Dept', 'department'),
			'subsections' => array(self::HAS_MANY, 'Subsections', 'section'),
		);
	}
